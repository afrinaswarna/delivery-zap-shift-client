...
const Register = () => {
  ...
  return (
    <div className=' className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl my-20 p-2'>
        ...
        <h4 className="text-sm">Register with ZapShift</h4>
      <form className="card-body" onSubmit={handleSubmit(handleRegistration)}>
        <fieldset className="fieldset">
          ...
          <p>Already have an account?<Link state={location.state} to='/login' className="text-violet-600 hover:underline">Login</Link></p>
        </fieldset>
